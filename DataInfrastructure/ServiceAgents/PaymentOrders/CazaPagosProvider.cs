...
private readonly ILogger<PagaFacilProvider> _logger;
...
public async Task<HttpResponseMessage> CancelPaymentOrderAsync(string id)
{
   // Logic to cancel a payment order
   try
   {
...
public async Task<HttpResponseMessage> PayPaymentOrderAsync(string id)
{
   // Logic to pay a payment order
   try
   {
